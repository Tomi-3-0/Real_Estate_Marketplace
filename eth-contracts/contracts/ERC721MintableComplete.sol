...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "Sender not owner of the contract");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "Cannot be a null address or address ks invalid");
        _owner = newOwner;
...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused(){
         require(_paused == false, "Contract not currently active/is paused");
         _;
     }
     modifier paused(){
...
contract ERC721 is Pausable, ERC165 {
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender, "this address already owns this token");
    ...
    function transferFrom(address from, address to, uint256 tokenId) public {
        require(_isApprovedOrOwner(msg.sender, tokenId), "sender not approved to spend");
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes memory _data) public {
        ...
        require(_checkOnERC721Received(from, to, tokenId, _data), "token not yet received");
    }
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] == address(0), "This token exists");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "sender must be token owner");
...
contract ERC721Enumerable is ERC165, ERC721 {
    ...
    function tokenByIndex(uint256 index) public view returns (uint256) {
        require(index < totalSupply(), "this token does not probably exist");
